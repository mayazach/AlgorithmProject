Αλαγιάννης Σπυρίδων 1115201300005
Ζαχαροπούλου Μαγδαληνή 1116201300046
...
τες σε καμπύλες πλέγματος και χρησιμοποιώντας είτε κλασική είτε πιθανοκρατική συνάρτηση κατακερματισμού. Στη συνέχεια ψάχνει να βρει 
τον κοντινότερο γείτονα με LSH και τον συγκρίνει με τον πραγματικό γείτονα που βρίσκει με εξαντλητική αναζήτηση σε έναν από τους 
πίνακες κατακερματισμού. Η απόσταση από τους γείτονες σε κάθε περίπτωση υπολογίζεται είτε με Discrete Frechet Distance είτε με Dynamic 
Time Warping, ανάλογα τι επιλέγει ο χρήστης. Σε περίπτωση που ζητείται ο υπολογισμός στατιστικών, η εξαντλητική αναζήτηση γίνεται την 
πρώτη φορά που κατασκευάζεται η δομή αναζήτησης και τις υπόλοιπες 99 εφαρμόζεται μόνο LSH. Δεν έχει υλοποιηθεί η αναζήτηση R-neighbors.
